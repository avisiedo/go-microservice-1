...
// MockServerInterface_GetOpenapi_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetOpenapi'
type MockServerInterface_GetOpenapi_Call struct {
	*mock.Call
}

// GetOpenapi is a helper method to define mock.On call
//   - ctx echo.Context
func (_e *MockServerInterface_Expecter) GetOpenapi(ctx any) *MockServerInterface_GetOpenapi_Call {
...
func (_c *MockServerInterface_GetOpenapi_Call) Return(err error) *MockServerInterface_GetOpenapi_Call {
	_c.Call.Return(err)
	return _c
}
